...
print('-------------')
# Bonus Challenge 2:
# Try repeating your solution Bonus Challenge 1, but ommitting the [] (if you
...
# Answer: Generator expression syntax will not create an intermediate list,
# instead summing up the results "on the fly" without intermediate data
# structures. This can be more efficient for large data sets.
