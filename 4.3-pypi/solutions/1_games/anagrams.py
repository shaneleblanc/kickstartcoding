...
def anagrams_advanced():
    ...
    hipster_words_list = [
        'intelligentsia', 'roof', 'party', 'pabst', 'irony', 'enamel',
        'pin', 'flannel', 'drinking', 'vinegar', 'chicken', 'portland',
        'poke', 'quinoa', 'vinyl', 'toast', 'keytar', 'scenester',
        'fixie', 'umami', 'bushwick', 'chartreuse', 'drinking',
        'vinegar', 'craft', 'beer', 'kitsch', 'distillery',
        'coldpressed', 'pickled', 'vaporware', 'brooklyn', 'organic',
